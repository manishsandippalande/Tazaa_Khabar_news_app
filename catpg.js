async function search(searchterm) {
    try {
      ...
      // Create the news item container
          ...
          const scontent = document.getElementById('newscontainer')
...
//   var button = document.getElementById("searchbtn");
  ...
  // Add a click event listener to the button
    ...
    searchterm = document.getElementById("category-opt").value;
    ...
    function trigger(){
      ...
      document.getElementById('newscontainer').removeChild(document.getElementById('newscontainer').firstChild)
    }
